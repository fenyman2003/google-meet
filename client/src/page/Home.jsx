...
const Home = () => {
  ...
  return (
    <div className="bg-[#ecfeff] min-h-screen text-slate-400">
      <div className="flex h-full md:gap-2 flex-col md:flex-row">
        <div className="p-3 w-auto h-auto items-center">
          ...
          <div>
            <div className="p-3 md:p-4 md:rounded-xl rounded md:text-base text-sm md:mt-6 mt-2 text-white md:font-semibold text-center w-full bg-blue">
              Made with love by
              <a
                href="https://github.com/fenyman2003"
                target={"_blank"}
                rel="noreferrer"
              >
                {" "}
        ...
        <div className="flex-grow md:h-screen md: p-3 md:p-4 bg-yellow-500">
          <div className="relative md:h-52 w-full bg-[#38bdf8] rounded md:rounded-2xl p-3">
            <div className="md:absolute bottom-2 left-2 md:bottom-6 md:left-6">
              ...
              <p className="text-[#f1f5f9] font-thin my-1">
